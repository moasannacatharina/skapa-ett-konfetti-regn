...
console.log(chooseParticleColor());
...
const bang = (addConfettiParticles) => {
  ...
  addConfettiParticles({
    groupName: "happy little confettis", // Valfritt namn på gruppen
    particleAmount: 170, // Antal konfettipartiklar
    xPosition: 50, // Position i procent av skärmens bredd, 0 är längst till vänster och 100 längst till höger
    yPosition: 40, // Position i procent av skärmens höjd, 0 är längst ner och 100 högst upp
    ...
    xSpread: 300, // Slumpmässig spridning på partikelns hastighet i sidled
    ySpread: 350, // Slumpmässig spridning på partikelns hastighet i höjdled
  });
};
